...
export default function MessageStatusIcon({ status, isOwn, isDark = false }) {
    ...
    return (
        <Svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ marginLeft: 3 }}>
            <Path d="M18 5L7 16l-5-5" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M22 5l-11 11-3-3" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        </Svg>
    );
}
