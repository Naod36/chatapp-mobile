 ...
 */
export default function PinnedListModal({
  visible,
  pinnedMessages = [],
  theme: t,
  onSelectMessage,
    ...
    >
      <SafeAreaView style={[styles.container, { backgroundColor: t.bg }]}>
        ...
        <View
          style={[
            styles.header,
            { borderBottomColor: t.borderColor, backgroundColor: t.cardBg },
          ]}
        >
        ...
        <FlatList
          data={pinnedMessages}
          keyExtractor={(item) =>
            String(item.pin_id || item.id || item.message_id)
          }
            ...
            return (
              ...
              >
                <View style={styles.itemMain}>
                  ...
                  <Text
                    style={[styles.itemText, { color: t.text }]}
                    numberOfLines={2}
                  >
                    {snippet}
                  </Text>
