...
export default function VoicePlayer({ src, isOwn, theme: t }) {
    ...
    const [peaks, setPeaks] = useState(() => [
        30, 50, 25, 75, 40, 85, 60, 35, 70, 50,
        90, 65, 30, 80, 45, 30, 70, 50, 30, 60,
        80, 40, 25, 55, 30, 45, 25, 35
    ]);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.waveWrap}>
                ...
                <View style={styles.timeRow}>
                    ...
                    <Text style={[styles.typeText, { color: isOwn ? "rgba(255,255,255,0.7)" : t.textMuted }]}>
                        Voice Message
                    </Text>
                </View>
            </View>
