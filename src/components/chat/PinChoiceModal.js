 ...
 */
export default function PinChoiceModal({
  visible,
  theme: t,
  isGroup = false,
  isAdmin = true,
              ...
              {step === "scope" ? (
                <>
                  ...
                  {canPinShared && (
                    ...
                    >
                      ...
                      <View style={styles.optionContent}>
                        ...
                        <Text
                          style={[styles.optionDesc, { color: t.textMuted }]}
                        >
                  ...
                  <TouchableOpacity style={styles.cancelBtn} onPress={onClose}>
                    <Text style={[styles.cancelText, { color: t.textMuted }]}>
                      Cancel
                    </Text>
                  </TouchableOpacity>
                </>
                ...
                <>
                  ...
                  <Text style={[styles.subtitle, { color: t.textMuted }]}>
                    Choose whether to send an in-app notification to all members
                    about this pin.
                  </Text>
